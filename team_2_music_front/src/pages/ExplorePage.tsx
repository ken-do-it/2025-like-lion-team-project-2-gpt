...
import { featuredPlaylists, trendingTracks } from "../data/mockTracks";
    ...
    <div className="space-y-12">
      ...
      >
        <div className="max-w-2xl space-y-4">
          ...
          <p className="text-white/70">AI가 만든 새로운 음악을 발견하고, 듣고, 공유하세요.</p>
      ...
      <section>
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-2xl font-bold">분위기 기반 플레이리스트</h2>
